...
const ProductDescription = dynamic(() => import('../../../../ar/components/ProductDetails/ProductDescription'));
const ProductDescriptionTab = dynamic(() => import('../../../../ar/components/ProductDetails/ProductDescriptionTab'));
...
const ProductBasic = ({
  ...
  return (
    <LayoutTwo>
      <NextSeo
        title={"جولدن باينتس | "+product.name }
