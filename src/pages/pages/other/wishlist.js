...
// import { BreadcrumbOne } from "";
const BreadcrumbOne = dynamic(() => import('../../../components/Breadcrumb/BreadcrumbOne'));
// import { IoIosClose, IoIosHeartEmpty } from "";
// const IoIosClose = dynamic(() => import('react-icons/io'));
const IoIosClose = dynamic(async () => (
  (await import("react-icons/io")).IoIosClose
));
const IoIosHeartEmpty = dynamic(() => import('react-icons/io'));
const Wishlist = ({
  wishlistItems,
  cartItems,
  addToCart,
